...
def SPADE(sequences, support, length):
    ...
    # print("frequent_1_sequences:",frequent_1_sequences)
    ...
    print("frequent_2_sequences:",frequent_2_sequences)
    ...
    for k in range(3, length+1):
        ...
        frequent_k_sequences = {k_sequence: count for k_sequence, count in frequent_k_sequences.items() if count >= support}
    ...
    return frequent_k_sequences,frequent_patterns
